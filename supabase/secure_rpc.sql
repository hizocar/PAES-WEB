-- Secure get_admin_student_performance for Student use
-- Allow users to view their OWN data, but deny viewing others unless Admin.

create or replace function public.get_admin_student_performance(
    p_user_id uuid,
...
declare
    ...
    v_usage_stats json;
begin
    -- Security Check: Admin OR the user themselves
