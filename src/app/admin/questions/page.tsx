...
export default function AdminQuestionsPage() {
    ...
    }, [questions, filterEje, filterDifficulty])

    const fetchData = async () => {
        // 1. Fetch Ejes for filter
        ...
        <div className="space-y-6 pb-20">
            ...
            <div className="grid gap-4">
                {filteredQuestions.map((q) => (
                    <div key={q.id} className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col md:flex-row items-start justify-between gap-4 hover:border-blue-300 transition-colors">
                        <div className="flex-1 space-y-3">
                            ...
                            {/* Question Content - using darker text for readability */}
